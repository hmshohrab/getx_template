...
abstract class AppColors {
  ...
  static const MaterialColor colorPrimarySwatch = kToDark;
  static const Color colorPrimary = ColorResources.kPrimaryColor;
  ...
  static const MaterialColor kToDark = MaterialColor(
    ...
    <int, Color>{
      50: Color(0xCC008E44), //10%
      100: Color(0xCC008E44), //20%
      200: Color(0xCC008E44), //30%
      300: Color(0xCC008E44), //40%
      400: Color(0xCC008E44), //50%
      500: Color(0xCC008E44), //60%
      600: Color(0xCC008E44), //70%
      700: Color(0xCC008E44), //80%
      800: Color(0xCC008E44), //90%
      900: Color(0xCC008E44), //100%
    },
  );
}
